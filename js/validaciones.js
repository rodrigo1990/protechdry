...
////////////Selector de div
	...
	$("#partido").change(function(){
            ...
            console.log(nombre_esta_validado);
					console.log(apellido_esta_validado);
					console.log(dni_esta_validado);
					console.log(email_esta_validado);
					console.log(cod_area_esta_validado);
					console.log(telefono_esta_validado);
					console.log(provincia_esta_validado);
					console.log(ciudad_esta_validado);
					console.log(cp_esta_validado);
					console.log(calle_esta_validado);
					console.log(altura_esta_validado);
					console.log(piso_esta_validado);
					console.log(departamento_esta_validado);
		...
		$("#departamento").keyup(function(){
			...
			if(envios_esta_activado==true){
				if(nombre_esta_validado==true&&apellido_esta_validado==true&&dni_esta_validado==true&&email_esta_validado==true&&cod_area_esta_validado==true&&telefono_esta_validado==true&&provincia_esta_validado==true&&ciudad_esta_validado==true&&cp_esta_validado==true&&calle_esta_validado==true&&altura_esta_validado==true&&piso_esta_validado==true&&departamento_esta_validado==true){
					...
					console.log("validar compra esta validado");
					partido = $("#partido").val();
		...
		if(partido=="LA MATANZA" || partido=="LOMAS DE ZAMORA" || partido=="QUILMES" || partido=="ALMIRANTE BROWN"
			...
			|| partido=="JOSE C. PAZ" || partido=="HURLINGHAM" || partido=="ITUZAINGO" || partido=="EZEIZA" || partido=="SAN FERNANDO" || partido=='C.A.B.A'){
				...
				$('#form-checkout').attr('action', 'comprarMpConEnvio.php');
					...
					console.log("validar compra is false");
